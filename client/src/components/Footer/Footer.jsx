...
function Footer() {
  return (
    <>
      {/* -------------- Nav Mobile---------------- */}
      <div className="flex flex-col py-12 bg-background mx-auto items-center">
